...
$TextBox_Search.Size = New-Object System.Drawing.Size(640,25)
...
$button_find_class.Location = New-Object System.Drawing.Point(530,49)
...
$search_service = @($out_find_class | Where {$_.Name -match "$search_text"}) # создать массив, т.к. если найдено 1 значение, то его тип данных PSCustomObject вместо Object[] Array (массив)
$temp = $search_service
$list = New-Object System.collections.ArrayList
$list.AddRange($temp)
$dataGridView.DataSource = $list
