...
$ComboBox_namespace.DataSource = @("root\CIMV2","root\CIMV2\Terminalservices")
...
$ComboBox_class.DataSource = @("System","Service","Process","Product","Fix","Device","Board","Disk","Memory","Video","Network","Driver","BIOS","Startup","Share",`
